...
import LogoS from '../../../assets/images/logo-s-black.png'
...
const Logo = () => {
    ...
    return (
        <div className='logo-container' ref={bgRef}>
            <img src={LogoS} className='solid-logo' alt='M'
            ref={solidLogoRef}></img>

            {/* <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
            xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="100%" viewBox="0 0 192 192" enable-background="new 0 0 192 192"
                 xmlSpace="preserve"> */}
                <svg
                    // width="559pt"
                    width="100%"
